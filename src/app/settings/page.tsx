                ...
                {[
                  {
                    ...
                    desc: "Уведомлять при назначении новой задачи",
                  },
                  {
                    key: "projectUpdates",
                    label: "Обновления проектов",
                    desc: "Уведомлять об изменениях в проектах",
                  },
                  {
                    key: "mentions",
                    label: "Упоминания",
                    desc: "Уведомлять при упоминании в комментариях",
                  },
                  {
                    key: "deadlineReminders",
                    label: "Напоминания о сроках",
                    desc: "Уведомлять о приближении дедлайнов",
                  },
                  {
                    key: "emailNotifications",
                    label: "Email уведомления",
                    desc: "Дублировать уведомления на email",
                  },
                ].map((item) => (
                  <div
                    key={item.key}
            ...
            <div className="bg-white rounded-2xl shadow-soft border border-surface-200 p-6">
              <div className="flex items-center space-x-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-ink-muted">
                    Настройте отображение интерфейса
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between py-3">
                  <div>
                    ...
                    <p className="text-xs text-ink-muted mt-0.5">
                      Уменьшает отступы для отображения большего количества
                      данных
                    </p>
                  </div>
                  <button
